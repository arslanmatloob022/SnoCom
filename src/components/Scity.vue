...
<template>
    <div class="EventList_wrapper"><a rel="noopener noreferrer" data-analytic-label="scityEventLink"
            data-analytic-event-content="qatar-event-show" class="CardEvent_card"
            href="/scity/workshop/workshop/qatar-event-show">
            <div class="CardEvent_imageWrapper"><img alt="Qatar Event Show image" loading="lazy" decoding="async"
                    data-nimg="fill" class="CardEvent_image"
            ...
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">1 Jan <br class="CardEvent_breakLine">4:28
                    AM</p>
                <p class="Typography_p8 CardEvent_tags">Workshop</p>
                <p class="Typography_p4 CardEvent_title">Qatar Event Show</p>
            </div>
            <div class="CardEvent_badge CardEvent_inAppRegistration"><span data-test-id=""
                    class="Icon_iconWrapper CardEvent_icon"><svg width="13" height="12" fill="none"
                        ...
                        <defs>
                            <clipPath id="snoonu_svg__a">
                                <path fill="currentColor" transform="translate(.227)" d="M0 0h12v12H0z"></path>
                            </clipPath>
                        </defs>
                    </svg></span>
                <p class="Typography_p10">Register</p>
            </div>
        </a><a rel="noopener noreferrer" data-analytic-label="scityEventLink"
            data-analytic-event-content="be-happy---children-and-family-play" class="CardEvent_card"
            href="/scity/family/family/be-happy---children-and-family-play">
            <div class="CardEvent_imageWrapper"><img alt="Be Happy - Children &amp; Family Play image"
                    loading="lazy" decoding="async" data-nimg="fill" class="CardEvent_image"
                    src="https://images.snoonu.com/snoofun/2025-08/c573674b-445e-4d97-8cde-70dd71bd8d41_output.png"
                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">4 Sep <br class="CardEvent_breakLine">9:30
                    PM</p>
                <p class="Typography_p8 CardEvent_tags">Family • Arabic Only</p>
                <p class="Typography_p4 CardEvent_title">Be Happy - Children &amp; Family Play</p>
            ...
            data-analytic-event-content="ceramic-cube-pottery-studio" class="CardEvent_card"
            href="/scity/family/arts-and-crafts/ceramic-cube-pottery-studio">
            <div class="CardEvent_imageWrapper"><img alt="Ceramic Cube Pottery Studio  image" loading="lazy"
                    decoding="async" data-nimg="fill" class="CardEvent_image"
            ...
            data-analytic-event-content="974cruises---houseboat-rental" class="CardEvent_card"
            href="/scity/things-to-do/things-to-do/974cruises---houseboat-rental">
            <div class="CardEvent_imageWrapper"><img alt="974Cruises - Houseboat Rental (Lusail Marina) image"
                    loading="lazy" decoding="async" data-nimg="fill" class="CardEvent_image"
                    src="https://images.snoonu.com/snoofun/2025-09/7d972608-038f-414e-8149-e6191c6241bc_output.png"
                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">4 Sep <br class="CardEvent_breakLine">10:00
                    PM</p>
                <p class="Typography_p8 CardEvent_tags">Things to Do</p>
                <p class="Typography_p4 CardEvent_title">974Cruises - Houseboat Rental (Lusail Marina)</p>
            ...
            data-analytic-event-content="974cruises---houseboat-rental" class="CardEvent_card"
            href="/scity/things-to-do/things-to-do/974cruises---houseboat-rental">
            <div class="CardEvent_imageWrapper"><img alt="974Cruises - Houseboat Rental (Doha Port) image"
                    loading="lazy" decoding="async" data-nimg="fill" class="CardEvent_image"
            ...
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">4 Sep <br class="CardEvent_breakLine">10:00
                    PM</p>
                <p class="Typography_p8 CardEvent_tags">Things to Do</p>
                <p class="Typography_p4 CardEvent_title">974Cruises - Houseboat Rental (Doha Port)</p>
                <p class="Typography_p8 CardEvent_price">from 800 QR</p>
            </div>
            <div class="CardEvent_badge CardEvent_inAppRegistration"><span data-test-id=""
                    class="Icon_iconWrapper CardEvent_icon"><svg width="13" height="12" fill="none"
            ...
            data-analytic-event-content="fällä--self-driven-solar-powered-boat" class="CardEvent_card"
            href="/scity/things-to-do/things-to-do/f%C3%A4ll%C3%A4--self-driven-solar-powered-boat">
            <div class="CardEvent_imageWrapper"><img alt="Fällä – Self-Driven Solar-Powered Boat image"
                    loading="lazy" decoding="async" data-nimg="fill" class="CardEvent_image"
                    src="https://images.snoonu.com/snoofun/2025-08/17436b22-569e-4444-83ee-d84f22f46996_output.png"
                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">5 Sep <br class="CardEvent_breakLine">11:00
                    AM</p>
                <p class="Typography_p8 CardEvent_tags">Things to Do</p>
                <p class="Typography_p4 CardEvent_title">Fällä – Self-Driven Solar-Powered Boat</p>
            ...
            data-analytic-event-content="société---cookies-baking" class="CardEvent_card"
            href="/scity/things-to-do/things-to-do/soci%C3%A9t%C3%A9---cookies-baking">
            <div class="CardEvent_imageWrapper"><img alt="Société - Cookies Baking  image" loading="lazy"
                    decoding="async" data-nimg="fill" class="CardEvent_image"
                    src="https://images.snoonu.com/snoofun/2025-08/18d1b6d0-0d14-46a3-8c5d-fac21fd0c0f4_output.png"
                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">5 Sep <br class="CardEvent_breakLine">12:00
                    PM</p>
                <p class="Typography_p8 CardEvent_tags">Things to Do</p>
            ...
            data-analytic-event-content="qool-qatar---flyboarding" class="CardEvent_card"
            href="/scity/family/family/qool-qatar---flyboarding">
            <div class="CardEvent_imageWrapper"><img alt="Qool Qatar - Flyboarding (Buy 1, Get 1 Free) image"
                    loading="lazy" decoding="async" data-nimg="fill" class="CardEvent_image"
            ...
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">5 Sep <br class="CardEvent_breakLine">12:00
                    PM</p>
                <p class="Typography_p8 CardEvent_tags">Family</p>
                <p class="Typography_p4 CardEvent_title">Qool Qatar - Flyboarding (Buy 1, Get 1 Free)</p>
            ...
            data-analytic-event-content="meryal-waterpark" class="CardEvent_card"
            href="/scity/things-to-do/beach-and-pool/meryal-waterpark">
            <div class="CardEvent_imageWrapper"><img alt="Meryal Waterpark image" loading="lazy" decoding="async"
                    data-nimg="fill" class="CardEvent_image"
            ...
            data-analytic-event-content="fly-over-wonders--flying-cinema" class="CardEvent_card"
            href="/scity/family/family/fly-over-wonders--flying-cinema">
            <div class="CardEvent_imageWrapper"><img alt="Fly Over Wonders – Flying Cinema image" loading="lazy"
                    decoding="async" data-nimg="fill" class="CardEvent_image"
                    src="https://images.snoonu.com/snoofun/2025-08/6a844e55-e20f-4546-af08-7e7f3227942c_output.png"
                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">5 Sep <br class="CardEvent_breakLine">1:00
                    PM</p>
                <p class="Typography_p8 CardEvent_tags">Family</p>
                <p class="Typography_p4 CardEvent_title">Fly Over Wonders – Flying Cinema</p>
            ...
            data-analytic-event-content="doha-quest---35-percent-discount" class="CardEvent_card"
            href="/scity/family/playgrounds/doha-quest---35-percent-discount">
            <div class="CardEvent_imageWrapper"><img alt="Doha Quest - 35% Discount image" loading="lazy"
                    decoding="async" data-nimg="fill" class="CardEvent_image"
                    src="https://images.snoonu.com/snoofun/2025-09/671a3408-39c0-46cc-a3b5-9c3e35e6cd59_output.png"
                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">5 Sep <br class="CardEvent_breakLine">4:00
                    PM</p>
                <p class="Typography_p8 CardEvent_tags">Family</p>
            ...
            data-analytic-event-content="nakama-cosplay-festival" class="CardEvent_card"
            href="/scity/festivals/festivals/nakama-cosplay-festival">
            <div class="CardEvent_imageWrapper"><img alt="Nakama Cosplay Festival  image" loading="lazy"
                    decoding="async" data-nimg="fill" class="CardEvent_image"
                    src="https://images.snoonu.com/snoofun/2025-08/e4f2c6b4-96f2-4f7f-9eb9-58845edbdc1b_output.png"
                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">5 Sep <br class="CardEvent_breakLine">5:00
                    PM</p>
            ...
            <div class="CardEvent_imageWrapper"><img alt="Be Happy - Children &amp; Family Play image"
                    ...
                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">5 Sep <br class="CardEvent_breakLine">7:30
                    PM</p>
                <p class="Typography_p8 CardEvent_tags">Family • Arabic Only</p>
                <p class="Typography_p4 CardEvent_title">Be Happy - Children &amp; Family Play</p>
                <p class="Typography_p8 CardEvent_price">from 195 QR</p>
            ...
            data-analytic-event-content="qool-qatar---fishing" class="CardEvent_card"
            href="/scity/family/sports/qool-qatar---fishing">
            <div class="CardEvent_imageWrapper"><img alt="Qool Qatar - Fishing  image" loading="lazy"
                    decoding="async" data-nimg="fill" class="CardEvent_image"
                    src="https://images.snoonu.com/snoofun/2025-09/865079db-18ee-48ff-b005-5617b60038b6_output.png"
                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">6 Sep <br class="CardEvent_breakLine">6:00
                    AM</p>
                <p class="Typography_p8 CardEvent_tags">Family • Things to Do • Sports</p>
            ...
            data-analytic-event-content="qool-qatar---wakeboarding" class="CardEvent_card"
            href="/scity/family/family/qool-qatar---wakeboarding">
            <div class="CardEvent_imageWrapper"><img alt="Qool Qatar - Wakeboarding (Buy 1, Get 1 Free) image"
                    loading="lazy" decoding="async" data-nimg="fill" class="CardEvent_image"
                    src="https://images.snoonu.com/snoofun/2025-08/294b7226-ba3e-418a-92a0-8e5754a0b297_output.png"
                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">6 Sep <br class="CardEvent_breakLine">7:00
                    AM</p>
                <p class="Typography_p8 CardEvent_tags">Family</p>
                <p class="Typography_p4 CardEvent_title">Qool Qatar - Wakeboarding (Buy 1, Get 1 Free)</p>
                <p class="Typography_p8 CardEvent_price">from 800 QR</p>
            </div>
            <div class="CardEvent_badge CardEvent_inAppRegistration"><span data-test-id=""
                    class="Icon_iconWrapper CardEvent_icon"><svg width="13" height="12" fill="none"
            ...
            data-analytic-event-content="qool-qatar---donut-ride" class="CardEvent_card"
            href="/scity/family/family/qool-qatar---donut-ride">
            <div class="CardEvent_imageWrapper"><img alt="Qool Qatar - Donut Ride (Buy 1, Get 1 Free) image"
                    loading="lazy" decoding="async" data-nimg="fill" class="CardEvent_image"
                    src="https://images.snoonu.com/snoofun/2025-08/d9ef3f4a-dad9-4e68-b4da-f0a660aa3a20_output.png"
                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">6 Sep <br class="CardEvent_breakLine">12:00
                    PM</p>
                <p class="Typography_p8 CardEvent_tags">Family</p>
                <p class="Typography_p4 CardEvent_title">Qool Qatar - Donut Ride (Buy 1, Get 1 Free)</p>
                <p class="Typography_p8 CardEvent_price">from 800 QR</p>
            </div>
            <div class="CardEvent_badge CardEvent_inAppRegistration"><span data-test-id=""
                    class="Icon_iconWrapper CardEvent_icon"><svg width="13" height="12" fill="none"
            ...
            data-analytic-event-content="qool-qatar---parasailing" class="CardEvent_card"
            href="/scity/family/family/qool-qatar---parasailing">
            <div class="CardEvent_imageWrapper"><img alt="Qool Qatar - Parasailing (10% Discount) image"
                    loading="lazy" decoding="async" data-nimg="fill" class="CardEvent_image"
            ...
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">6 Sep <br class="CardEvent_breakLine">12:00
                    PM</p>
                <p class="Typography_p8 CardEvent_tags">Family</p>
                <p class="Typography_p4 CardEvent_title">Qool Qatar - Parasailing (10% Discount)</p>
            ...
            data-analytic-event-content="qool-qatar---banana-ride" class="CardEvent_card"
            href="/scity/family/family/qool-qatar---banana-ride">
            <div class="CardEvent_imageWrapper"><img alt="Qool Qatar - Banana Ride (Buy 1, Get 1 Free) image"
                    loading="lazy" decoding="async" data-nimg="fill" class="CardEvent_image"
            ...
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">6 Sep <br class="CardEvent_breakLine">12:00
                    PM</p>
                <p class="Typography_p8 CardEvent_tags">Family</p>
                <p class="Typography_p4 CardEvent_title">Qool Qatar - Banana Ride (Buy 1, Get 1 Free)</p>
                <p class="Typography_p8 CardEvent_price">from 800 QR</p>
            </div>
            <div class="CardEvent_badge CardEvent_inAppRegistration"><span data-test-id=""
                    class="Icon_iconWrapper CardEvent_icon"><svg width="13" height="12" fill="none"
            ...
            <div class="CardEvent_imageWrapper"><img alt="Ceramic Cube Pottery Studio  image" loading="lazy"
                    ...
                    style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;"></div>
            <div class="CardEvent_content__X_xHx">
                <p class="Typography_p6 CardEvent_date">6 Sep <br class="CardEvent_breakLine">3:00
                    PM</p>
                <p class="Typography_p8 CardEvent_tags">Family</p>
                <p class="Typography_p4 CardEvent_title">Ceramic Cube Pottery Studio </p>
                <p class="Typography_p8 CardEvent_price">from 80 QR</p>
...
.DateRangePicker_root .DateRangePicker_selectedDay__KMK_j .DateRangePicker_dayButton {
    color: var(--text-primary)
}

.DateRangePicker_root .DateRangePicker_selectedDay__KMK_j .DateRangePicker_dayButton:focus {
    outline: none
}
...
.DateRangePicker_root .DateRangePicker_rangeEnd___KAiR .DateRangePicker_dayButton,
.DateRangePicker_root .DateRangePicker_rangeStart .DateRangePicker_dayButton {
    background: var(--control-tertiary);
    border-color: var(--control-tertiary);
    filter: drop-shadow(0 4px 22px rgba(0, 0, 0, .2))
}
