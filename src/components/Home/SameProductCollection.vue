...
<template>
 <div class="FeedContent_productList FeedContent_fullWidth"
    style="background-color: rgb(255, 238, 230); max-width: 100%;">
    
    <!-- Header -->
    <div class="ProductList_header___Cxqp" style="color: rgb(140, 12, 0); margin-top: 0px;">
      <h2 class="Typography_h2 ProductList_title mt-0">Back to School Essentials</h2>
      <a href="/selections/tablet-zone" rel="noopener noreferrer">
        <button class="Button_button Button_secondary Button_small SeeAll_button">
        ...
        <a :href="product.href" target="_blank" class="productCard">
          <div class="ProductsCarousel_card">
            ...
            <div class="ProductInfo_wrapper p-2">
              ...
              <p class="Typography_p14__r_99o ProductInfo_label">{{ product.title }}</p>

              <!-- Ratings -->
              <div v-if="product.rating" class="flex items-center space-x-2 mt-1">
                <p class="text-sm font-medium text-gray-600">{{ product.rating }}</p>
