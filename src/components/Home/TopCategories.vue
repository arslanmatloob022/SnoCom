...
const slides = ref([
  {
    ...
    image:
      "https://images.snoonu.com/promo_banners/2025-08/9eb3d28c-e3c4-4a87-b5bb-0e5e677c492c_output.png?format=webp",
  },
  {
    id: 2,
    title: "Back to School - Electronics",
    image:
      "https://images.snoonu.com/banner/2025-08/0c057aab-61e1-478f-95c5-1e0abb585f61_output.png",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    image:
      "https://images.snoonu.com/promo_banners/2025-08/69784d02-9615-463e-8880-9e18343748bc_output.png?format=webp",
  },
  {
    id: 5,
    title: "Fight the Flu",
    image:
      "https://images.snoonu.com/promo_banners/2025-08/1b623ede-271a-4e48-86c5-415aae378eab_output.png?format=webp",
  },
  {
    id: 6,
    title: "Free Delivery (FV x GV)",
    image:
      "https://images.snoonu.com/promo_banners/2025-07/10f3cbde-ce8b-41b9-9223-f54538ea4d39_output.png?format=webp",
  },
  {
    id: 7,
    title: "Refresh Your Day",
    image:
      "https://images.snoonu.com/promo_banners/2025-08/8d43fb39-d666-42b2-b4ba-cf5325b49c2c_output.png?format=webp",
  },
  {
    id: 8,
    title: "Matcha Mania",
    image:
      "https://images.snoonu.com/promo_banners/2025-07/7371ebac-7ba9-421c-956f-80fb9f18f50d_output.png?format=webp",
  },
  {
    id: 9,
    title: "Snoomart x Royal Club",
    image:
      "https://images.snoonu.com/promo_banners/2025-08/7ede3e08-6f3d-4944-bc32-6544fe97a17f_output.png?format=webp",
  },
  {
    id: 10,
    title: "Unmissable Arrivals",
    image:
      "https://images.snoonu.com/promo_banners/2025-07/06ff80c5-fcce-45de-897e-21f5b498f9f3_output.png?format=webp",
  },
  {
    id: 11,
    title: "Corporate Offers",
    image:
      "https://images.snoonu.com/promo_banners/2025-04/d2f738da-3fa9-4235-9d27-8b4806c499cf_output.png?format=webp",
  },
  {
    id: 12,
    title: "Al Furjan",
    image:
      "https://images.snoonu.com/promo_banners/2024-10/342e0f8c-7930-49af-9698-1d73737964d5_output.png?format=webp",
  },
]);
onMounted(() => {
  get_categories();
...
const categories = computed(() => [
  ...
  // },
  {
    name: t('categories.healthBeauty'),
    alt: t('categories.healthBeauty'),
  ...
  {
    name: t('categories.toysKids'),
    alt: t('categories.toysKids'),
  ...
  {
    name: t('categories.stationery'),
    alt: t('categories.stationery'),
...
<template>
  <div class="">
    <h1 class="Typography_h1 HiddenTitle_title">
      Snoonu - online shopping with fast delivery
    </h1>
    <div class="HeroSection_wrapper">
      ...
      <div class="TopBanners_wrapper">
        ...
        <div class="TopBannersTimedBanners_wrapper">
          <a
            class="TopBannersTimedBanners_imageWrapper"
            href="/selections/2047?byId=1"
            ><img
              alt="Back to School - Electronics"
              loading="lazy"
              decoding="async"
              data-nimg="fill"
          ...
          ><a
            class="TopBannersTimedBanners_imageWrapper"
            href="/categories/5363"
            ><img
              alt="International Dog Day"
              loading="lazy"
              decoding="async"
              data-nimg="fill"
              class="TopBannersTimedBanners_image"
              ...
              "
              src="https://images.snoonu.com/banner/2025-08/4cd82334-ffee-479c-a05d-9699ee437aca_output.png"
          /></a>
        </div>
      </div>
    </div>
